const translations = {
  fr: {
    ...
    res_subtitle:
      "Profitez de notre ambiance chaleureuse pour vos repas ou événements spéciaux",
    res_table_title: "Réserver une table",
    res_table_desc:
      "Idéal pour le petit-déjeuner, le déjeuner ou le café de l'après-midi.",
    res_table_btn: "Réserver",
    res_event_title: "Privatiser l'espace",
    res_event_desc:
      "Organisez vos événements privés ou professionnels dans notre boulangerie.",
    ...
    success_res_desc:
      "Nous avons bien reçu votre demande de réservation. Nous vous contacterons bientôt pour confirmer.",
  },
  en: {
    nav_about: "About",
    nav_menu: "Menu",
    ...
    success_res_desc:
      "We have received your reservation request. We will contact you shortly to confirm.",
  },
  de: {
    nav_about: "Über uns",
    ...
    res_subtitle:
      "Genießen Sie unsere gemütliche Atmosphäre für Ihre Mahlzeiten oder besondere Anlässe",
    res_table_title: "Tisch reservieren",
    res_table_desc:
      "Perfekt für Frühstück, Mittagessen oder Nachmittagskaffee.",
    res_table_btn: "Jetzt reservieren",
    res_event_title: "Raum für Veranstaltung buchen",
    res_event_desc:
      "Veranstalten Sie Ihre privaten oder geschäftlichen Events in unserer Bäckerei.",
    ...
    success_res_desc:
      "Wir haben Ihre Reservierungsanfrage erhalten. Wir werden uns in Kürze bei Ihnen melden, um sie zu bestätigen.",
  },
  it: {
    nav_about: "Chi siamo",
    nav_menu: "Menu",
    ...
    res_subtitle:
      "Goditi la nostra atmosfera accogliente per i tuoi pasti o eventi speciali",
    ...
    res_event_desc:
      "Ospita i tuoi eventi privati o aziendali nella nostra panetteria.",
    ...
    success_res_desc:
      "Abbiamo ricevuto la tua richiesta di prenotazione. Ti contatteremo a breve per confermare.",
  },
  uk: {
    nav_about: "Про нас",
    nav_menu: "Меню",
    ...
    res_subtitle:
      "Насолоджуйтесь затишною атмосферою для ваших зустрічей або особливих подій",
    res_table_title: "Забронювати столик",
    res_table_desc:
      "Ідеально для сніданку, обіду або післяобідньої кави з випічкою.",
    res_table_btn: "Забронювати",
    res_event_title: "Орендувати для події",
    res_event_desc:
      "Організуйте ваші приватні або корпоративні заходи в нашій пекарні.",
    ...
    success_res_desc:
      "Ми отримали ваш запит на бронювання. Ми зв'яжемося з вами найближчим часом для підтвердження деталей.",
  },
};
